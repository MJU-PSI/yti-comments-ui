...
import { ignoreModalClose, comparingLocalizable } from '@goraresult/yti-common-ui';
...
export class OrganizationsInputComponent implements ControlValueAccessor {
  ...
  organizations$: Observable<OrganizationSimple[]>;
  ...
  removeOrganization(organization: OrganizationSimple) {
